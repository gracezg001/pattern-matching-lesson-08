...
object HighOrderFunctionDemo extends App {
  val DIVIDED_LINE = "_________________________________________"
  ...
  val allchildren = List(marriage1surname, marriage2, marriage3)
  println(allchildren)

  println(DIVIDED_LINE)
  val allchildrenFlat = allchildren.flatten

  println("________________before flatten_______________________")
  ...
  val fruits = Seq("apple", "orange", "kivi")
